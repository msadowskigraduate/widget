package com.example.sadowsm3.widget.widget;
...
import com.example.sadowsm3.widget.image.ImageService;
import com.example.sadowsm3.widget.music.MusicPlayerService;
import com.example.sadowsm3.widget.R;
...
public class HomeScreenWidget extends AppWidgetProvider {
    ...
    public static final String ACTION_PLAY = "com.example.sadowsm3.widget.MUSIC_PLAYER_PLAY";
    public static final String ACTION_PAUSE = "com.example.sadowsm3.widget.MUSIC_PLAYER_PAUSE";
    public static final String ACTION_NEXT_TRACK = "com.example.sadowsm3.widget.MUSIC_PLAYER_NEXT";
    public static final String ACTION_PREV_TRACK = "com.example.sadowsm3.widget.MUSIC_PLAYER_PREV";
    public static final String ACTION_WEB_BROWSER = "com.example.sadowsm3.widget.WEB_BROWSER";
    public static final String ACTION_CHANGE_IMAGE = "com.example.sadowsm3.widget.CHANGE_IMAGE";
    ...
    private void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        createWebBrowserPendingIntent(context, remoteViews, "https://www.yahoo.com",
                R.id.web_button );
